...
@section('content')
    ...
    <div class="container">
        ...
        <div class="card">
            <form novalidate action="{{ route('editsubmit', ['id' => $data['task'] -> id]) }}" method="post">
                @csrf

                <div class="form-group">
                    <label for="taskTitle" class="form-label">عنوان</label>
                    <input name="title" type="text" class="form-control" value="{{ $data['task'] -> title }}" id="taskTitle">
                </div>

                <div class="form-group">
                    <label for="taskDescription" class="form-label">شرح کامل</label>
                    <textarea name="content" class="form-control" id="taskDescription" rows="5"> {{ $data['task'] -> content }} </textarea>
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 25px 35px;">
                    ...
                    <div class="form-group">
                        ...
                        <input name="project_name" type="text" class="form-control" value="{{ $data['task'] -> project_name }}" id="taskTitle">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="preference" class="form-control" id="taskPriority">
                            ...
                            <option>{{ $data['task'] -> preference }}</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-control" id="taskStatus">
                            ...
                            <option>{{ $data['task'] -> status }}</option>
                    ...
                    <div class="form-group">
                        ...
                        <input name="deadline" type="date" class="form-control" id="taskDueDate" value="{{ $data['task'] -> deadline }}">
                    </div>
                    ...
                    <div class="form-group"><label for="taskAssignee" class="form-label">مسئول</label>
                        <select name="undertaking" class="form-control" id="taskAssignee">
                            ...
                            <option>{{ $data['task'] -> undertaking }}</option>
